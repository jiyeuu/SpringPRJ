		...
		<div class="container">
			<div class="row justify-content-between callto-top-wrap pt-40 pb-40">
				<div class="col-lg-12 callto-top">
					...
					<form name="f" method="POST" action="/notice/noticeRegProc.do"
						id="regform" onsubmit="return check(this);">
						<div class="form-group"></div>
						<label for="text">제목</label>
						 <input type="text"
							class="form-control" id="title" name="title" /> <br>
						...
						<input type="submit" class="btn btn-primary" id="reg_btn1"
							value="등록">
					</form>
<script>
